...
public class TripStartedActivityDriver2 extends AppCompatActivity implements LocationListener, OnMapReadyCallback, GoogleApiClient.ConnectionCallbacks,
        GoogleApiClient.OnConnectionFailedListener {


    public static TextView already_paid_tv;
    public static TripStartedActivityDriver2 mInstance;
    ...
    View.OnClickListener navigation = new View.OnClickListener() {
        ...
        public void onClick(View v) {
            ...
            } else if (Function.isConnectingToInternet(TripStartedActivityDriver2.this)) {
                /*isNavi = true;
    ...
    View.OnClickListener call = new View.OnClickListener() {
        ...
        public void onClick(View v) {
            ...
            if (trip.getService_id().equalsIgnoreCase("4")) {
                ...
                new SweetAlertDialog(TripStartedActivityDriver2.this, SweetAlertDialog.CUSTOM_IMAGE_TYPE)
    ...
    protected void onCreate(Bundle savedInstanceState) {
      ...
      /*  if (ContextCompat.checkSelfPermission(mInstance, Manifest.permission.SEND_SMS) != PackageManager.PERMISSION_GRANTED) {
        ...
        if (FusedLocationService.mGoogleApiClient == null) {
            new FusedLocationService(TripStartedActivityDriver2.this);
        } else {
...
//        }
    ...
    public void StopTrip() {
        ...
        alertDialog.setPositiveButton("YES",
                new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        JSONParser jsonParser = new JSONParser(TripStartedActivityDriver2.this);
                            ...
                            public void success(String response) {
                                ...
                                if (address.isEmpty()) {
                                    if (trip.getDestinationAddress() == null) {
                                        AppPreferencesDriver.setDestiaddress(TripStartedActivityDriver2.this, "N/A");
                                    } else {
                                        AppPreferencesDriver.setDestiaddress(TripStartedActivityDriver2.this, trip.getDestinationAddress());
                                    }
                                } else {
                                    Logger.log("Addresss::", "sorce:DONE>>>" + address.get(0).address);
                                    String destinationAddress = address.get(0).address;
                                    AppPreferencesDriver.setDestiaddress(TripStartedActivityDriver2.this, destinationAddress);
                                }
                                finishTrip();
                            ...
                            public void error(String response) {
                                ...
                                try {
                                    ...
                                    if (object.getString("status").equals("200")) {
                                        ...
                                        new SweetAlertDialog(TripStartedActivityDriver2.this, SweetAlertDialog.WARNING_TYPE)
                                                .setTitleText("Oops...")
        ...
        if (!((AppCompatActivity) TripStartedActivityDriver2.this).isFinishing()) {
            alertDialog.show();
        }
    }
    ...
    private void finishTrip() {
        ...
        Logger.log("Addresss::", "sorce:" + AppPreferencesDriver.getSourceaddress(TripStartedActivityDriver2.this)
                + "\nDest:" + AppPreferencesDriver.getDestiaddress(TripStartedActivityDriver2.this));
...
//        DistanceTravelled distanceTravelled = dbAdapter_driver.getDistance(DriverStatus.ON_TRIP);
        ...
        if(totalDistance1 == 0.0){
            try {
                totalDistance1 = new Double(AppPreferencesDriver.getEstmatedistance(TripStartedActivityDriver2.this).split("-")[0]).doubleValue();
            } catch (Exception e) {
                e.printStackTrace();
            }
        }
        ...
        int basic = AppPreferencesDriver.getBasicFare(TripStartedActivityDriver2.this);
        int perFare = AppPreferencesDriver.getPerFare(TripStartedActivityDriver2.this);
        ...
        try {
            String[] estLoc = AppPreferencesDriver.getEstmatedistination(TripStartedActivityDriver2.this).split("-");
            Location.distanceBetween(Double.valueOf(estLoc[0]).doubleValue(), Double.valueOf(estLoc[1]).doubleValue(),
                    Double.valueOf(AppPreferencesDriver.getLatitude(TripStartedActivityDriver2.this)).doubleValue(),
                    Double.valueOf(AppPreferencesDriver.getLongitude(TripStartedActivityDriver2.this)).doubleValue(), results);
        } catch (Exception e) {
            e.printStackTrace();
        }
        ...
        try {
            String minmaxValue = AppPreferencesDriver.getEstmateprice(TripStartedActivityDriver2.this);
            ...
            if (AppPreferencesDriver.getServiceType(TripStartedActivityDriver2.this).equalsIgnoreCase("saprateOtherServices")
                    || (AppPreferencesDriver.getPerkmcharge(TripStartedActivityDriver2.this).equalsIgnoreCase("0"))) {
                ...
                if (isWithin200m) {
                    ...
                    JSONArray array = new JSONArray(AppPreferencesDriver.getDeleveryCharge(TripStartedActivityDriver2.this));
                    for (int i = 0; i < array.length(); i++) {
                        ...
                        if (totalDistance1 <= a) {
                            ...
                            if (trip.getService_id().equalsIgnoreCase("4")) {
                                ...
                                payment1 =  ((totalDistance1) * perFare) + basic;
                            } else {
                                payment1 = new Double(jsonObject.getString("price")).doubleValue() + ((totalDistance1 - a) * 10);
                            }
            ...
            } else if (totalDistance1 == 0.0 && AppPreferencesDriver.getLatitude(TripStartedActivityDriver2.this) == 0.0) {
                payment1 = min_fare;
                try {
                    totalDistance1 = new Double(AppPreferencesDriver.getEstmatedistance(TripStartedActivityDriver2.this).split("-")[0]).doubleValue();
                } catch (Exception e) {
                ...
                if (isWithin200m) {
                    ...
                    LatLng destination = new LatLng(AppPreferencesDriver.getLatitude(TripStartedActivityDriver2.this),
                            AppPreferencesDriver.getLongitude(TripStartedActivityDriver2.this));
                    String url = Function.getDirectionsUrl(source, destination);
                    RoutesDownloadTask downloadTask = new RoutesDownloadTask(TripStartedActivityDriver2.this, payment1);
...
//
    ...
    private void finishTripNext(double payment1) {
        ...
        String discountAmount = AppPreferencesDriver.getPromocode(TripStartedActivityDriver2.this);
        String referalDiscount = AppPreferencesDriver.getRefferalcode(TripStartedActivityDriver2.this);
        ...
        try {
            ...
            Date date1 = simpleDateFormat.parse(AppPreferencesDriver.getStartTime(TripStartedActivityDriver2.this));
        ...
        try {
            ...
            jsonObject.put("driver_id", AppPreferencesDriver.getDriverId(TripStartedActivityDriver2.this));
            ...
            jsonObject.put("type", AppPreferencesDriver.getDrivertype(TripStartedActivityDriver2.this));
            ...
            jsonObject.put("discount", AppPreferencesDriver.getPromocode(TripStartedActivityDriver2.this));
            jsonObject.put("referalUse", AppPreferencesDriver.getRefferalcode(TripStartedActivityDriver2.this));
            jsonObject.put("promo_id", AppPreferencesDriver.getPromoid(TripStartedActivityDriver2.this));
            jsonObject.put("pickup_Address", AppPreferencesDriver.getSourceaddress(TripStartedActivityDriver2.this).trim());
            jsonObject.put("drop_Address", AppPreferencesDriver.getDestiaddress(TripStartedActivityDriver2.this).trim());

            jsonObject.put("pickup_lat", AppPreferencesDriver.getSourcelatitude(TripStartedActivityDriver2.this));
            jsonObject.put("pickup_lng", AppPreferencesDriver.getSourcelongitude(TripStartedActivityDriver2.this));
            jsonObject.put("drop_lat", AppPreferencesDriver.getDestilatitude(TripStartedActivityDriver2.this));
            jsonObject.put("drop_lng", AppPreferencesDriver.getDestilogitude(TripStartedActivityDriver2.this));


            if (Function.isConnectingToInternet(TripStartedActivityDriver2.this)) {
                TripFinishTask(jsonObject);
            } else {
                String sms = "bike4everything tripEnd-" + FusedLocationService.getLocation().getLatitude() + "," + FusedLocationService.getLocation().getLongitude() + "," + Totalpayment + "," + trip.getId() + "," + AppPreferencesDriver.getDriverId(TripStartedActivityDriver2.this) + "," + jsonObject.getString("trip_distance");
                ...
                boolean isDeleted = dbAdapter_driver.deleteTripById(Integer.parseInt(AppPreferencesDriver.getTripId(TripStartedActivityDriver2.this)));
                //Logger.log("isDeleted", isDeleted + "   >>>>>>>>>>>");
                dbAdapter_driver.deleteLocation();
                dbAdapter_driver.deleteDistance();

                AppPreferencesDriver.setTripStart(TripStartedActivityDriver2.this, "no");
                //finish();

                try {
                    Intent intent1 = new Intent(TripStartedActivityDriver2.this, RecieptActivityDriver.class);
                    intent1.putExtra("driver_name", trip.getDropCname());
                    intent1.putExtra("pickup_address", jsonObject.getString("pickup_Address"));
                    intent1.putExtra("drop_address", jsonObject.getString("drop_Address"));
                    intent1.putExtra("trip_distance", jsonObject.getString("trip_distance"));
                    ...
                    intent1.putExtra("trip_id", jsonObject.getString("trip_id"));
                    intent1.putExtra("datetime", AppPreferencesDriver.getTripdate(TripStartedActivityDriver2.this));
                    intent1.putExtra("totalDistance1", String.valueOf(totalDistance1));
                    intent1.putExtra("msg", tripEndMsg);
                    startActivity(intent1);
                    finish();
    ...
    public void errorDialog(Context context, String msg) {
        ...
        AlertDialog.Builder builder = new AlertDialog.Builder(TripStartedActivityDriver2.this);
...
//            Logger.log("direction...", result);
    ...
    public class RoutesDownloadTask extends AsyncTask<String, Void, String> {
        ...
        public RoutesDownloadTask(Context context, double payment) {
            ...
            dialogManagerDriver.showProcessDialog(TripStartedActivityDriver2.this, "", true);
        }
        ...
        public class ParserTask extends AsyncTask<String, Integer, List<List<HashMap<String, String>>>> {
            ...
            protected void onPostExecute(List<List<HashMap<String, String>>> result) {
                ...
                try {
                    ...
                    min_fare = AppPreferencesDriver.getBasicFare(TripStartedActivityDriver2.this)
                            + (AppPreferencesDriver.getPerFare(TripStartedActivityDriver2.this) * minDist1)
                            + AppPreferencesDriver.getOtherFare(TripStartedActivityDriver2.this);
                    max_fare = AppPreferencesDriver.getBasicFare(TripStartedActivityDriver2.this)
                            + (AppPreferencesDriver.getPerFare(TripStartedActivityDriver2.this) * maxDist1)
                            + AppPreferencesDriver.getOtherFare(TripStartedActivityDriver2.this);
