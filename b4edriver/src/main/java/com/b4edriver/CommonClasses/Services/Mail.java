...
/**
 * Created by manishsingh on 21/11/17.
 */
...
// /mixed part, so this bit needs to be added.
    ...
    public boolean send() throws Exception {
        ...
        if(!_user.equals("") && !_user.equals("") && _to.length > 0 && !_from.equals("") &&
...
// send email
            ...
            try {
                t.connect("smtp.gmail.com","hvantageproject1@gmail.com", "hvantage@123");
