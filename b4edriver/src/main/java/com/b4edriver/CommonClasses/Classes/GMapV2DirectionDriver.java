...
public class GMapV2DirectionDriver {
    public final static String MODE_DRIVING = "driving";
    public final static String MODE_WALKING = "walking";

    public GMapV2DirectionDriver() {
    }
    ...
    public ArrayList<String> getTurnText(Document doc) {
        ArrayList<String> arrayList = new ArrayList<String>();
        try {

            NodeList nl1 = doc.getElementsByTagName("step");
            Log.i("DurationText1", nl1.getLength()+"");
            if (nl1.getLength() > 0) {
                for (int i = 0; i < nl1.getLength(); i++) {
                    Node node1 = nl1.item(i);
                    NodeList nl2 = node1.getChildNodes();
                    Log.i("DurationText2", nl2.getLength()+"");
                    Node node2 = nl2
                            .item(getNodeIndex(nl2, "maneuver"));
                    Log.i("DurationText3", node2.getNodeName());
    ...
    public String getDistanceText(Document doc) {
        ...
        try {
            ...
            Node node2 = nl2.item(getNodeIndex(nl2, "value"));
            Logger.log("DistanceText", node2.getTextContent());
            return node2.getTextContent();
        } catch (Exception e) {
            return "-1";
        }
         ...
         * node2 = nl2.item(getNodeIndex(nl2, "value")); Logger.log("DistanceText",
