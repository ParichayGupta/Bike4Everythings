...
public class LocationFetcherDriver implements ConnectionCallbacks, OnConnectionFailedListener {
    ...
    protected void startLocationUpdates(long interval) {
        ...
        this.activityIntent = PendingIntent.getBroadcast(this.context, 12321, new Intent(this.context, ActivityReceiverDriver.class), PendingIntent.FLAG_UPDATE_CURRENT);
