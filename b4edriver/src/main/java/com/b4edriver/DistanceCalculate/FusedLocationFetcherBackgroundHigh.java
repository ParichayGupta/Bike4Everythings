...
public class FusedLocationFetcherBackgroundHigh implements ConnectionCallbacks, OnConnectionFailedListener {
    ...
    protected void startLocationUpdates(long interval) {
        try {
            ...
            this.locationIntent = PendingIntent.getBroadcast(this.context, LOCATION_PI_ID, new Intent(this.context, FusedLocationReceiverBackgroundHigh.class), PendingIntent.FLAG_UPDATE_CURRENT);
