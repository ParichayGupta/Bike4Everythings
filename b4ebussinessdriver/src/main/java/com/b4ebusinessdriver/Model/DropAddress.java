...
public class DropAddress implements Parcelable {
    ...
    protected DropAddress(Parcel in) {
        ...
        this.dropId = ((String) in.readValue((String.class.getClassLoader())));
    ...
    public final static Creator<DropAddress> CREATOR = new Creator<DropAddress>() {
